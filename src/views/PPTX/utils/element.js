...
export function createTextBox(subType, fontFamily, fontColor) {
...
export function createGeometry(geometryName, fillStyle, strokeStylePaint) {
    const width = 200
    const height = 200
...
export function createTable(rowColumnDataList, rowFillStyles, borderColor, fontColor) {
...
export function createChart(title, chartType, rowColumnDataList, colors) {
    if (!colors) {
        colors = [
